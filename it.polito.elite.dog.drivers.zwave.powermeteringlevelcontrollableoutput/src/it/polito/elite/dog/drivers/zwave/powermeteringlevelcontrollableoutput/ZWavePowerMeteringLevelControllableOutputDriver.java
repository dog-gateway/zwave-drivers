...
public class ZWavePowerMeteringLevelControllableOutputDriver extends ZWaveDeviceDriver
{
	...
	public ZWavePowerMeteringLevelControllableOutputDriver()
	{
		super();
		this.driverInstanceClass = ZWavePowerMeteringLevelControllableOutputDriverInstance.class;
	}
			...
			BundleContext context)
	{
		...
		return new ZWavePowerMeteringLevelControllableOutputDriverInstance(zWaveNetwork, device, nodeId, instancesId,
				gatewayEndpoint, gatewayNodeId, updateTimeMillis, stepPercentage, this.logger, context);
	}
	...
	public void updated(Dictionary<String, ?> properties) throws ConfigurationException
	{
		if (properties != null)
		{
			...
			{
				this.logger.warn(ZWaveInfo.PROPERTY_STEP_PERCENT + " not defined in configuraton file for "
