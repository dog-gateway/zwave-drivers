...
public class ZWaveTemperatureAndHumiditySensorDriver extends ZWaveDeviceDriver
{

	/**
	 * 
	 */
	public ZWaveTemperatureAndHumiditySensorDriver()
	{
		super();
		this.driverInstanceClass = ZWaveTemperatureAndHumiditySensorDriverInstance.class;
	}
