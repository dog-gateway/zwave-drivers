...
public class ZWaveThreePhaseElectricityMeterDriver extends ZWaveDeviceDriver
{
	...
	{
		super();
		this.driverInstanceClass = ZWaveThreePhaseElectricityMeterInstance.class;
	}
	...
	{
		return new ZWaveThreePhaseElectricityMeterInstance(zWaveNetwork, device, nodeId, instancesId, gatewayEndpoint,
